                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    ...
                                                    ) return [3 /*break*/, 3]; //Hide bets from known users
                                                    // Get market details 
                                                ...
                                                case 2:
                                                    ...
                                                    if (dollarStake > hideBetsBellow) {
                                                        ...
                                                        //send to private all trades channel
                                                        helperFunctions.sendDiscordMessage('1086556537155235870', discordMessage);
                                                    }
                                                    _a.label = 3;
