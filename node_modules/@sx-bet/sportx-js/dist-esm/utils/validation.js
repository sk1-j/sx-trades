...
export function validateIGetPendingBetsRequest(payload) {
...
export function validateIGetTradesRequest(payload) {
...
export function validateIFillDetailsMetadata(metadata) {
...
export function validateIRelayerMakerOrder(order) {
...
export function validateISignedRelayerMakerOrder(order) {
...
export function validateINewOrderSchema(order) {
 ...
 */
export function isPositiveBigNumber(object) {
    try {
